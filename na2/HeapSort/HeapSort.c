...
2. Ordenação
    2.1 A cada iteração obtem-se o maior elemento do heap (raiz do heap, indice 0 do vetor) e adicione-o em um segmento ordenado.
    2.2 Após a subtração da raiz, reorganiza-se o heap (restaura_heap)
*/
